...
INCBIN "gfx/tilesets/new_bark_town.2bpp.lz"

TilesetNewBarkTownMeta::
INCBIN "data/tilesets/new_bark_town_metatiles.bin"

TilesetNewBarkTownColl::
INCLUDE "data/tilesets/new_bark_town_collision.asm"
...
INCBIN "data/tilesets/new_bark_town_attributes.bin"